...
import (
	...
	"github.com/legendzhouwd/cu_crypto/core/gm/account"
	"github.com/legendzhouwd/cu_crypto/core/gm/base58"
	"github.com/legendzhouwd/cu_crypto/core/gm/config"
	"github.com/legendzhouwd/cu_crypto/core/gm/gmsm/sm2"
	"github.com/legendzhouwd/cu_crypto/core/gm/hash"
...
func (k *ExtendedKey) ToString() string {
	...
	checkCode := hash.HashUsingSM3(serializedBytes)
...
func NewKeyFromString(key string) (*ExtendedKey, error) {
	...
	checkCode := hash.HashUsingSM3(payload)
